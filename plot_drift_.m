...
function plot_drift_(P)
    ...
    switch lower(vcMode_com)
        ...
        case 'rawstd'
            mrVp = squeeze_(var(single(getSpikeWaveforms(P, 1))));
    ...
    if ~isempty(S_clu)
        ...
        for iClu = 1:S_clu.nClusters
            ...
            switch vcMode_drift
                ...
                case 'xya'
                    if S_clu.vrSnr_clu(iClu) < snr_thresh_clu
                        continue;
                    end
                ...
                case 'z'
                    ...
                    if posX_clu1 < posX_lim(1) || posX_clu1 > posX_lim(2) || posY_clu1 < posY_lim(1) || posY_clu1 > posY_lim(2)
                        continue;
                    end
        ...
        switch vcMode_drift
            case 'tay'
                plot3(ax, vrTime_spk, vrAmp_spk, vrPosY_spk, 'o', 'MarkerSize', 5);

            case 'x'
                plot(ax, vrTime_spk, vrPosX_spk, '.', 'MarkerSize', 5);

            case 'y'
                plot(ax, vrTime_spk, vrPosY_spk, '.', 'MarkerSize', 5);

            case 'xy'
                plot(ax, vrPosX_spk, vrPosY_spk, '.', 'MarkerSize', 5);

            case 'xya'
                plot3(ax, vrPosX_spk, vrPosY_spk, vrAmp_spk, '.', 'MarkerSize', 5);
