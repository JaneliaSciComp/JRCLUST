...
suites = [ ...
    ...
    TestSuite.fromClass(?jrclust.test.DensityPeakClustering.ReorderTest) ...
...
suites = [ ...
    TestSuite.fromClass(?jrclust.test.TemplateClustering.AutoMergeTest) ...
    ...
    TestSuite.fromClass(?jrclust.test.TemplateClustering.ReorderTest) ...
...
suites = [ ...
    TestSuite.fromClass(?jrclust.test.DensityPeakClustering.CurateController.AutoDeleteTest) ...
    TestSuite.fromClass(?jrclust.test.DensityPeakClustering.CurateController.AutoMergeTest) ...
    ...
    TestSuite.fromClass(?jrclust.test.DensityPeakClustering.CurateController.ReorderClustersTest) ...
    ...
    TestSuite.fromClass(?jrclust.test.TemplateClustering.CurateController.AutoDeleteTest) ...
    TestSuite.fromClass(?jrclust.test.TemplateClustering.CurateController.AutoMergeTest) ...
    ...
    TestSuite.fromClass(?jrclust.test.TemplateClustering.CurateController.ReorderClustersTest) ...
