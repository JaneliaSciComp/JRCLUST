function dispFeatures = getFigProjFeatures2(hClust, sitesToShow, selected)
    ...
    % spikes occurring on these sites and within these times and in iCluster
    iMask = (hClust.spikeClusters == iCluster) & siteMask & timeMask;
    ...
    % subselect spikes from iCluster, jCluster, and background
