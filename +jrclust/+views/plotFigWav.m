function hFigWav = plotFigWav(hFigWav, hClust, hCfg, maxAmp, channel_idx)
    ...
    if ~hFigWav.hasAxes('default') % construct from scratch
        ...
        hFigWav = plotSpikeWaveforms(hFigWav, hClust, hCfg, maxAmp, channel_idx);
        hFigWav = plotMeanWaveforms(hFigWav, hClust, hCfg, maxAmp, channel_idx);
