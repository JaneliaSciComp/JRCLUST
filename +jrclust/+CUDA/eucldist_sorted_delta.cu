 ...
 */
__global__ void eucldist_sorted_delta(float const *A, unsigned int const *I, float *D, unsigned int *N, int const nA, int const nneigh, int const nC){
