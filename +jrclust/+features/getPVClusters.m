function [prVecs1, prVecs2] = getPVClusters(hClust, sites, iCluster, jCluster)
    ...
    sampledWindows = permute(jrclust.utils.getSampledWindows(hClust, sampledSpikes, sites, false), [1, 3, 2]); % nSamples x nSpikes x nSites
    ...
    if isempty(jCluster)
        ...
        sampledWindows2 = permute(jrclust.utils.getSampledWindows(hClust, sampledSpikes2, sites, false), [1, 3, 2]); % nSamples x nSpikes x nSites
        for kSite = 1:nSites
