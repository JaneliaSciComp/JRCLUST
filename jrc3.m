...
switch lower(vcCmd)
    % No arguments
    case 'setprm', vcFile_prm_ = vcArg1; return;
...
if get_set_(P, 'fSpatialMask_clu', 1)
    mrFet12_ = bsxfun(@times, mrFet12_, spatialMask_(P, iSite, size(mrFet12_,1), P.maxDist_site_um));
end
...
if size(tmrWav,1) == nSamples_raw, return ;end
