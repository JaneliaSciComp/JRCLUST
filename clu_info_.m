...
function clu_info_(S0)
    ...
    if ~isempty(S0.iCluPaste)
        ...
        S0.iCluCopy, S_clu.clusterNotes{S0.iCluCopy}, ...
        S0.iCluPaste, S_clu.clusterNotes{S0.iCluPaste});
        set(mh_info, 'Label', vcLabel);
    else
        S_clu2 = [];
        vcLabel = sprintf('Unit %d "%s"', S0.iCluCopy, S_clu.clusterNotes{S0.iCluCopy});
        set(mh_info, 'Label', vcLabel);
    end
