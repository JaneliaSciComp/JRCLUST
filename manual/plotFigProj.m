...
function plotFigProj(S0)
    ...
    switch lower(P.displayFeature)
        ...
        otherwise
            vcXLabel = sprintf('Site # (%%0.0f %s; upper: %s1; lower: %s2)', P.displayFeature, P.displayFeature, P.displayFeature);
            vcYLabel = sprintf('Site # (%%0.0f %s)', P.displayFeature);
    end
    ...
    S_fig = mergeStructs(S_fig, ...
        makeStruct_(vcTitle, iClu1, iClu2, viSites_show, vcXLabel, vcYLabel, displayFeature));
    S_fig.csHelp = { ...
        '[D]raw polygon', ...
        '[S]plit cluster', ...
