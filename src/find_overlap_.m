...
function [cviSpk_o_1, cviSpk_o_12, cviDelay1] = find_overlap_(S0, S_clu, P)
    ...
    % [viTime_spk, vrAmp_spk, viSite_spk] = multifun_(@jrclust.utils.tryGpuArray, S0.viTime_spk, abs(squeeze(trFet_spk(1,1,:))), S0.viSite_spk);
    ...
    for iClu1 = 1:S_clu.nClu
        ...
        [viOverlap1, cviDelay1{iClu1}] = multifun_(@(x)jrclust.utils.tryGather(x(vlOverlap1)), viOverlap1, viDelay1);
