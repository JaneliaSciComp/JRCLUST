...
function S_clu = S_clu_update_(S_clu, viClu1, P)
    ...
    S_clu.computeMeanWaveforms(P, viClu1);
    ...
    S_clu.mrWavCor = jrclust.utils.setDiag(S_clu.mrWavCor, vrSelfCorr_clu);
    for iClu = 1:numel(viClu1)
        iClu1 = viClu1(iClu);
        S_clu.mrWavCor(iClu1,iClu1) = S_clu.computeSelfSim(iClu1);
    end
