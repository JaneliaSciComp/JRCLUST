function update_FigTime_()
    ...
    set0_(P);
    [vrFet0, vrTime0, vcYlabel] = getFigTimeFeatures(S_fig.iSite, [], S0);
    ...
    set(S_fig.hPlot1, 'YData', getFigTimeFeatures(S_fig.iSite, S0.iCluCopy, S0));

    if ~isempty(S0.iCluPaste)
        set(S_fig.hPlot2, 'YData', getFigTimeFeatures(S_fig.iSite, S0.iCluPaste, S0));
    else
